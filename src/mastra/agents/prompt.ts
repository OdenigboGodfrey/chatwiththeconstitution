...
HOWEVER: Under no circumstances should you respond with more than ${process.env.LLM_MAX_GENERATED_CHARACTERS!} words. If the answer cannot fit, provide a concise summary and end with: "Reply with 'continue' to receive the remaining details.
STRICT RULES:
