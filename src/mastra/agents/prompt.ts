...
const maxGenerateWords = process.env.LLM_MAX_GENERATED_WORDS!;
...
HOWEVER: Under no circumstances should you respond with more than ${maxGenerateWords} words. If the answer cannot fit, provide a concise summary and end with: "Reply with 'continue' to receive the remaining details.
STRICT RULES:
